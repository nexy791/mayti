...
import com.ribsky.mayti.presenters.MainPresenter
...
//ca-app-pub-3940256099942544/5224354917 - test
    ...
    override fun criticalError() {
        AlertsUtils(this).alertCriticalError()
    }

    override fun criticalErrorAuth() {
        AlertsUtils(this).alertRelogin()
    ...
    override fun startApp(user: UserModel, users: ArrayList<UserModel>) {
        ...
        ExtraUtils().addReward(this, currentAccount.uid)

        currentCoin = ExtraUtils().getLikes(this, currentAccount.uid)
        updateBadger()
